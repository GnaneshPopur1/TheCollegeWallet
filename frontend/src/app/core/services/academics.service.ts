...
export class AcademicsService {
  ...
  createTerm(termData: any): Observable<any> {
    return this.http
      .post<any>(`${this.apiUrl}/terms`, termData, this.getHeaders())
      .pipe(catchError(this.handleError<any>('createTerm')));
  }

  updateDiningBalance(termId: string, newBalance: number): Observable<any> {
    return this.http
      .patch<any>(`${this.apiUrl}/terms/${termId}/dining`, { new_balance: newBalance }, this.getHeaders())
      .pipe(catchError(this.handleError<any>('updateDiningBalance')));
  }
